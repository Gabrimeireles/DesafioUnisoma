class Profissional:
    def __init__(self, nome ,tipo, horas_semana, faixa_atendimento, disponibilidade, virtual, localidade):
    ...
    def pode_atender_localidade(self, localidade):
        return self.localidade in localidade
    
    def __str__(self):
        return f'Profissional: {self.nome} - Tipo: {self.tipo} - Horas Semana: {self.horas_semana} - Faixa Atendimento: {self.faixa_atendimento} - Localidade: {self.localidade} - Virtual: {self.virtual} - Disponibilidade: {self.disponibilidade}'